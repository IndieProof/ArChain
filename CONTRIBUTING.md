Contributing to ArCh/ain
============================

The ArCh/ain project operates an open contributor model where anyone is
...
The following applies to code changes to the ArCh/ain project, and is not to be
confused with overall ACASH Network Protocol consensus changes.

Whether a pull request is merged into ArCh/ain rests with the project merge
...
Patches that change ACASH consensus rules are considerably more involved than
...
Where a patch set proposes to change the ACASH consensus, it must have been
...
The project leader is the release manager for each ArCh/ain release.
