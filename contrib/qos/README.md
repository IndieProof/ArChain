...
This means one can have an always-on archaind instance running, and another local archaind/archain-qt instance which connects to this node and receives blocks from it.
