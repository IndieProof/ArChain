...
RESOURCES += src/qt/archain.qrc src/qt/archain_locale.qrc

TRANSLATIONS += src/qt/locale/archain_bg.ts \
                src/qt/locale/archain_de.ts \
                src/qt/locale/archain_en.ts \
                src/qt/locale/archain_es.ts \
                src/qt/locale/archain_fi.ts \
                src/qt/locale/archain_fr.ts \
                src/qt/locale/archain_it.ts \
                src/qt/locale/archain_ja.ts \
                src/qt/locale/archain_pl.ts \
                src/qt/locale/archain_pt.ts \
                src/qt/locale/archain_ru.ts \
                src/qt/locale/archain_sk.ts \
                src/qt/locale/archain_sv.ts \
                src/qt/locale/archain_vi.ts \
                src/qt/locale/archain_zh_CN.ts \
                src/qt/locale/archain_zh_TW.ts
