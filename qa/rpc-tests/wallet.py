...
#   c) node1 mines 32 blocks, so now node 0 has 60001archain, node 1 has 4250archain, node2 has none.
#   d) node0 sends 601 archain to node2, in two transactions (301 archain, then 300 archain).
