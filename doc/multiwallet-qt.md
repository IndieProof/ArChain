...
In order to support loading of multiple wallets in archain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is archain.cpp.
...
Changes to archain.cpp
----------------------
archain.cpp is the entry point into archain-qt, and as such, will require some minor modifications to provide hooks for
