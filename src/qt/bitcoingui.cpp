...
QFontDatabase::addApplicationFont(":/fonts/archain_font");

QString windowTitle = tr("ArCh/ain") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ACASH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ACASH: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ArCh/ain"), this);
    aboutAction->setStatusTip(tr("Show information about ArCh/ain"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ACASH"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ACASH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ACASH addresses"));
    ...
    openAction->setStatusTip(tr("Open a ACASH: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the ArCh/ain help message to get a list with possible ACASH command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ArCh/ain client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ACASH network", "", count));
}
...
{
    QString strTitle = tr("ArCh/ain"); // default title
