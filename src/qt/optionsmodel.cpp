...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::ACASH);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeXDnaAmount"))
        SoftSetArg("-anonymizearchainamount", settings.value("nAnonymizeXDnaAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in archain.cpp during shotdown to also remove the window positions
