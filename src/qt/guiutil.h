...
/** Utility functions used by the ACASH Qt UI.
 */
namespace GUIUtil
{
...
// Render ACASH addresses in monospace font
...
// Parse "archain:" URI into recipient object, return true on successful parsing
