...
#if defined(NDEBUG)
#error "ACASH cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uarchain) are considered zero fee (for relaying and mining)
